...
//   console.log("Lo que se envia", req.body);

//   const { priceId } = req.body; // El priceId que recibimos desde el cliente

//   try {
//     // Obtenemos el precio real del producto a partir del priceId
//     const price = await stripe.prices.retrieve(priceId);

//     const paymentIntent = await stripe.paymentIntents.create({
//       amount: price.unit_amount, // Usamos el monto del precio del producto (en centavos)
//       currency: price.currency,  // Usamos la misma moneda que el precio
