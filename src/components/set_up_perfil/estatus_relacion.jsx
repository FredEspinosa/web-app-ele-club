...
const EstatusDeRelacion = () => {
  ...
  const handleContinuar = () => {
    if (selectedValue && selectedValue.length > 0) {
      ...
      const nuevosDatos = {
        ...datosUsuario,
        relationshipStatus: Array.isArray(selectedValue)
        ...
        <div className="club_contenedor container-lg club_sub_contenedor">
          ...
          <div className="club_cont_info_grow_1">
            ...
            <div className="col-12 club_margin_top_56">
              ...
              <OpcionesCheck opciones={opciones} onOptionSelect={handleOptionSelect} tituloDeLista={tituloDeLista} iconoCheck={iconoCheck} multiselect={true} />
            </div>
          </div>
