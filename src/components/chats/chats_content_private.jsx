...
const ChatsContentPrivate = ({ handleOnClick, listChatsPrivates, onDelete }) => {
  ...
  return (
    <>
      {listChatsPrivates && listChatsPrivates.length > 0 ? (
        <SwipeableList>
          {listChatsPrivates.map((chatList) => {
                  ...
                  <div className="col-12 d-flex justify-content-center flex-wrap align-items-center">
                    <div className="col-10 d-flex align-items-center">
                      <div className="club_requqest_content_photo">
                        <img className="club_cont_perfil_img" src={otroUsuario?.user?.userPhotos?.[0]?.photo || PerfilDefault} alt="" />
                      </div>
                      <div>
...
ChatsContentPrivate.propTypes = {
  handleOnClick: PropTypes.func,
  listChatsPrivates: PropTypes.array,
