...
const AlertSuscribeStatic = ({ cerrarModal, mensajeModal, btnAceptar, btnMsjButtom, handleOnclick, bgColorButton }) => {
  ...
  return (
    <div id='aletrStatic'>
        <div className="modal club_modal_suscribe club_alert_static">
...
export default AlertSuscribeStatic;
